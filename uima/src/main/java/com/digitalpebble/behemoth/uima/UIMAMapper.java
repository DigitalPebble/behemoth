...
public class UIMAMapper extends BehemothMapper {
	...
	public void map(BehemothDocument behemoth,
			AvroCollector<BehemothDocument> output, Reporter reporter)
			throws IOException {

		LOG.debug("UIMA processing " + behemoth.getUrl());
		...
		super.map(behemoth, output, reporter);
	}
